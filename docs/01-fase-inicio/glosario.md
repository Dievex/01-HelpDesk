...
| Término | Definición |
| --- | --- |
| Administrador del Sistema | Usuario responsable de configurar categorías, SLA, usuarios y permisos dentro de una instancia. |
| Agente de Soporte | Usuario responsable de atender y resolver tickets asignados. Se clasifica por nivel (N1, N2, N3) según la complejidad que puede resolver. |
...
| Categoría | Clasificación temática de un ticket (ej. Hardware, Software, Red, Cuentas de usuario) que orienta su ruta de atención. |
...
| Supervisor | Agente de Soporte con responsabilidad adicional de vigilar la carga de trabajo del equipo y revisar métricas y cumplimiento de SLA. Requiere el mismo conocimiento técnico que un agente para poder dirigirlos, y puede atender tickets directamente aunque no sea su función principal. |
